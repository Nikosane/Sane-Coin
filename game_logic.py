...
def start_game(words):
    ...
    # Now, implement the new decryption logic for the selected chunks
    mine_logic(selected_chunks, [chunk for chunk, _ in encrypted_chunks_with_info], desired_word, keys, program_key)
